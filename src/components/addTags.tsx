...
const AddTags = ({cardListTag, update, cardId}:addTags) => {
    ...
    const [colorTag, setColorTag] = useState("#111111");
    ...
    return(
        <div className="absolute z-10 sm:left-[40%] top-[30%] w-[300px] flex flex-col bg-2 border-[1px] border-white/30 text-white rounded-[10px] mt-2 pb-5 max-h-[403px] px-3" >
